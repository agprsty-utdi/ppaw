...
@section('title', 'Master Tabel Riwayat Pangkat')
@section('content_header')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/home">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Master Tabel Riwayat Pangkat</li>
        </ol>
    </nav>
@stop
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span id="card_title">
                                <h3>Master Tabel Riwayat Pangkat</h3>
                            </span>
